...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'yurisantos@tuamarsa.com',
    'santos@tuamaeaquelaursa.com'
  ])
  ...
  function addNewEmailToInvite (event: FormEvent<HTMLFormElement>){
    ...
    //verifica se já existe o email, se existir, não add na lista
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestsInputs} className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>
                Alterar local/data
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' onClick={openGuestsModel} className="flex items-center gap-2 flex-1 text-left">
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='py-1.5 px-2.5 rounded-md bg bg-zinc-800 flex items-center gap-2'>
